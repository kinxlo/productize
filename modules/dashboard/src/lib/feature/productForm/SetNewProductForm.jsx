...
import { Box, Card, Center, Flex, FormControl, FormHelperText, FormLabel, Image, Input, InputGroup, SimpleGrid, Stack, Text } from "@chakra-ui/react";
            ...
            <SimpleGrid my={8}>
                ...
                <Box mt={`5rem`} mb={8}>
                    <Flex flexDir={{ base: `column`, lg: `row` }} alignItems={`flex-start`} justifyContent={`space-between`} gap={5}>
                        ...
                        <Box>
                            ...
                            />
                            <Box display={dataPreview.length ? `block` : `none`}>
                                <SharedButton
                                    btnExtras={{
                ...
                <Box my={8}>
                    <Flex flexDir={{ base: `column`, lg: `row` }} alignItems={`flex-start`} justifyContent={`space-between`} gap={5}>
                        ...
                        <Box>
                            ...
                            />
                            {/*alt button for cover photo*/}
                            <Box display={coverPhotoPreview.length ? `block` : `none`}>
                                <SharedButton
                                    btnExtras={{
                                        leftIcon: `ri:file-upload-line`,
                                        border: `1px solid #6D5DD3`,
                ...
                <Box my={8}>
                    <>
                        ...
                        {/*<Box display={ thumbnailPreview ? `none` : `none` }>*/}
                        {/*    <SharedButton*/}
                        {/*        btnExtras={ {*/}
                        {/*            leftIcon:`ri:file-upload-line`,*/}
                        {/*            border:`1px solid #6D5DD3`,*/}
                    ...
                    >
                        ...
                        />
                        {/*<Box display={ thumbnailPreview == null ? `none` : `block` }>*/}
                        <SharedButton
                            btnExtras={{
                                leftIcon: `ri:file-upload-line`,
                                border: `1px solid #6D5DD3`,
                    ...
                    <FormControl color={`grey.400`} mt={4}>
                        <FormControl color={`grey.400`} mt={4}>
                            <Flex justifyContent={`space-between`} alignItems={`center`}>
                                <FormLabel className="small-text">Show Stock Counat</FormLabel>
